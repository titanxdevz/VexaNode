...
const faqs = [
  {
    ...
    a: "Hytale server hosting allows you to run your own dedicated multiplayer worlds, custom adventures, and community servers with high-tickrate performance, instant automated setup, and always-on uptime with domestic Indian routing."
  },
  {
    q: "Where are the Hytale server locations?",
    a: "We offer low latency Hytale game nodes located directly in Mumbai (India), Germany (Frankfurt), and USA with domestic peering for low nationwide ping."
  },
  {
...
export default function HytaleClient() {
  ...
  return (
    <div className="min-h-screen vx-bg vx-ink selection:bg-amber-500/30 relative overflow-hidden font-sans">
      ...
      <main className="relative z-10 pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-12">
          <div className="max-w-3xl">
            ...
            {/* Description */}
            <p className="vx-muted2 text-sm sm:text-base leading-relaxed mb-5">
              Experience high-quality Hytale server hosting with high-performance hardware, low latency, instant setup, and advanced DDoS protection. VexaNode provides affordable and reliable Hytale hosting with dependable uptime and optimized infrastructure for smooth multiplayer gameplay. Get fast, secure, and lag-free Hytale game server hosting for communities, survival worlds, and custom adventures.
            </p>
                ...
                <button
                  ...
                  className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer whitespace-nowrap flex-shrink-0 flex items-center gap-2 border ${
                    isActive
                      ...
                      : "vx-card vx-muted2 border vx-line hover:border-amber-500/40 vx-hover-ink"
                  }`}
                >
                ...
                <div
                  ...
                  className={`relative rounded-2xl vx-card border transition-all duration-300 p-6 flex flex-col justify-between hover:-translate-y-1.5 shadow-xl ${
                    plan.popular
                      ...
                      : "vx-line hover:border-amber-500/50"
                  }`}
                >
                  <div>
                    ...
                    <div className="flex items-center justify-between gap-3 mb-6">
                      <div className="flex items-center gap-3.5">
                        ...
                        <div>
                          <h4 className="text-base font-bold vx-ink orbitron-font leading-tight">{plan.name}</h4>
                          <span className="text-xs vx-muted">Hytale Server</span>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-y-4 gap-x-6 mb-5">
                      ...
                      <div>
                        ...
                        <div className="text-sm font-bold vx-ink">{plan.protection}</div>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Scheduled world snapshots keep your player builds, custom scripts, and progress safe."
              }
            ].map((feat, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-5 rounded-2xl vx-card border vx-line hover:border-amber-500/40 transition-all"
                >
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-4 text-left font-medium text-xs sm:text-sm vx-ink hover:text-amber-400 transition-colors"
                >
                  <span>{faq.q}</span>
                  <ChevronDown
