      ...
      <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          {dbPlans.map((plan, idx) => (
            ...
            >
              <div className={`absolute -inset-[1px] rounded-[40px] bg-gradient-to-b from-white/0 via-white/0 to-white/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm ${plan.id === 'sql' ? 'group-hover:from-teal-500/10 group-hover:via-teal-500/5 group-hover:to-transparent' :
              ...
              <div className={`relative bg-[#0c0e1a]/40 backdrop-blur-xl border border-white/[0.06] rounded-[40px] p-8 transition-all duration-500 overflow-hidden hover:border-white/[0.12]`}>
                <div className={`absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none ${plan.id === 'sql' ? 'from-teal-500/5 via-transparent to-transparent' :
                ...
                <div className="relative">
                  ...
                  <div className="relative mb-8">
                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] border border-white/[0.06] flex items-center justify-center group-hover:scale-110 transition-all duration-500 relative z-10 ${plan.id === 'sql' ? 'group-hover:border-teal-500/30' :
                    ...
                    <div className={`absolute inset-0 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500 scale-75 group-hover:scale-110 opacity-0 group-hover:opacity-100 ${plan.id === 'sql' ? 'bg-teal-500/10' :
                        plan.id === 'mongodb' ? 'bg-emerald-500/10' :
                          'bg-rose-500/10'
                      }`} />
                  </div>

                  <h3 className={`text-2xl font-black mb-4 orbitron-font uppercase tracking-tight transition-colors ${plan.id === 'sql' ? 'group-hover:text-teal-400' :
