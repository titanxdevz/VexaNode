  ...
  return (
    <div className="min-h-screen bg-[#0a0b0f] text-white selection:bg-[#10b981]/30">
      ...
      <main className="pt-32 pb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold mb-6 orbitron-font leading-tight">
                About <span className="text-[#10b981] text-neon-glow-brand">VexaNode</span>
              </h1>
              ...
              <div className="flex gap-4">
                <div className="bg-[#10b981]/10 border border-[#10b981]/20 px-6 py-3 rounded-2xl">
                  <span className="text-[#10b981] font-bold">Founded in 2026</span>
                </div>
                <div className="bg-[#10b981]/5 border border-white/5 px-6 py-3 rounded-2xl">
            ...
            <motion.div
              ...
              className="relative aspect-video rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-[#10b981]/10"
            >
              <Image
          ...
          <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {stats.map((stat, idx) => (
                ...
                >
                  <stat.icon className="w-8 h-8 text-[#10b981] mx-auto mb-4" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-8 rounded-3xl bg-[#0b0c16]/30 backdrop-blur-md border border-white/10 hover:border-[#10b981]/30 transition-all group"
              >
                <div className={`w-14 h-14 rounded-2xl mb-6 flex items-center justify-center bg-[#10b981]/10 border border-[#10b981]/20 group-hover:scale-110 transition-transform`}>
        ...
        <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto mb-24">
          <div className="bg-gradient-to-br from-blue-900/10 to-[#10b981]/10 border border-white/10 rounded-[40px] p-8 md:p-16 overflow-hidden relative">
        ...
        <section className="px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center">
          <div className="bg-[#10b981]/10 border border-[#10b981]/25 rounded-3xl p-12 shadow-[0_0_50px_rgba(16,185,129,0.15)]">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <button className="bg-[#10b981] text-white hover:bg-[#059669] px-8 py-4 rounded-xl font-bold hover:scale-105 transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)]">
                Get Started
              </button>
