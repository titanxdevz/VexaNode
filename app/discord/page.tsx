        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="relative flex items-center gap-2 bg-white/[0.04] border border-white/[0.06] p-1.5 rounded-2xl backdrop-blur-md">
              <div
                className={`absolute top-1.5 bottom-1.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-400 transition-all duration-300 ease-out shadow-[0_0_15px_rgba(16,185,129,0.3)] ${selectedCycle === "monthly" ? "left-1.5 right-[75%]" :
              ...
              {cycles.map((cycle) => (
                <button
                  ...
                  className={`relative z-10 px-5 py-2.5 rounded-xl text-xs font-bold transition-all duration-300 uppercase tracking-wider cursor-pointer flex-1 min-w-0 whitespace-nowrap ${selectedCycle === cycle.id
                      ? "text-white"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-32">
          {botPlans.map((plan, idx) => (
            ...
            >
              ...
              <div className={`relative bg-[#0c0e1a]/40 backdrop-blur-xl border rounded-[40px] overflow-hidden transition-all duration-500 ${plan.popular
                ...
                <div className="relative p-8 flex flex-col">
                  ...
                  <button
                    ...
                    className={`group/btn relative flex items-center justify-center gap-2 w-full py-4 rounded-2xl font-bold transition-all duration-500 cursor-pointer orbitron-font uppercase tracking-wider text-xs overflow-hidden ${plan.popular
                        ? 'text-white'
