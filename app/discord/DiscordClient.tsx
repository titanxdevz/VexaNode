...
export default function DiscordClient() {
  ...
  return (
    <div className="min-h-screen bg-[#050711] text-white selection:bg-blue-500/30 relative overflow-hidden font-sans">
                ...
                <button
                  ...
                  className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer whitespace-nowrap flex-shrink-0 flex items-center gap-2 border ${
                    isActive
                      ...
                      : "bg-[#0a0f1d]/90 text-gray-300 border-[#1e293b] hover:border-blue-500/40 hover:text-white"
                  }`}
                >
                ...
                <div
                  ...
                  className={`relative rounded-2xl bg-[#080d1a]/95 border transition-all duration-300 p-6 flex flex-col justify-between hover:-translate-y-1.5 shadow-xl ${
                    plan.popular
                      ...
                      : "border-[#17233d] hover:border-blue-500/50 hover:bg-[#0a1122]"
                  }`}
                >
                  <div>
                    ...
                    <div className="flex items-center justify-between gap-3 mb-6">
                      <div className="flex items-center gap-3.5">
                        ...
                        <div>
                          ...
                          <span className="text-xs text-gray-400">Discord Bot</span>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-y-4 gap-x-6 mb-5">
                      ...
                      <div>
                        ...
                        <div className="text-sm font-bold text-white">{plan.bandwidth}</div>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Multi-layer UDP/TCP DDoS mitigation keeps your bot online and responsive 24/7."
              },
              {
                icon: Database,
              ...
              return (
                <div
                  key={idx}
                  className="p-5 rounded-2xl bg-[#080d1a]/80 border border-[#17233d] hover:border-blue-500/40 transition-all"
                >
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-4 text-left font-medium text-xs sm:text-sm text-white hover:text-blue-400 transition-colors"
                >
                  <span>{faq.q}</span>
                  <ChevronDown
